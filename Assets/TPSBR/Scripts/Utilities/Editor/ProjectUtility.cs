namespace TPSBR
{
	...
	public static class ProjectUtility
	{
		...
		{
			// REMOVED DATE: Ensures cross-platform compatibility even if builds are made on different days
			PhotonAppSettings.Global.AppSettings.AppVersion = $"{Application.version}-public";
			EditorUtility.SetDirty(PhotonAppSettings.Global);
