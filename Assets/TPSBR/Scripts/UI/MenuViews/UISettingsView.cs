...
namespace TPSBR.UI
{
	public class UISettingsView : UICloseView
	{
		...
		[SerializeField]
		private UISlider _cameraDistanceSlider;
		...
		protected override void OnInitialize()
		{
			...
			if (_cameraDistanceSlider != null)
				_cameraDistanceSlider.onValueChanged.AddListener(OnCameraDistanceChanged);
		...
		protected override void OnDeinitialize()
		{
			...
			if (_cameraDistanceSlider != null)
				_cameraDistanceSlider.onValueChanged.RemoveListener(OnCameraDistanceChanged);
		...
		private void LoadValues()
		{
			...
			if (_cameraDistanceSlider != null)
				_cameraDistanceSlider.SetOptionsValueFloat(runtimeSettings.Options.GetValue(RuntimeSettings.KEY_CAMERA_DISTANCE));
		...
		private void OnResetButton()
		{
			...
			options.ResetValueToDefault(RuntimeSettings.KEY_CAMERA_DISTANCE, false);
		...
		{
			Context.RuntimeSettings.CameraDistance = _cameraDistanceSlider.value;
		}
