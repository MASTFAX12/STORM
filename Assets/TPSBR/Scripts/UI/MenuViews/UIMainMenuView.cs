	...
	public class UIMainMenuView : UIView
	{
...
#if ENABLE_PLAYFAB
		[SerializeField]
		private UIButton _friendsButton;
#endif
		...
		protected override void OnInitialize()
		{
			...
			if (_friendsButton != null)
				_friendsButton.onClick.AddListener(OnFriendsButton);
#endif
...
#if ENABLE_PLAYFAB
			if (_friendsButton != null)
				_friendsButton.onClick.RemoveListener(OnFriendsButton);
#endif
		...
		{
			var friendsView = Open<UIFriendsView>();
			friendsView.BackView = this;
			Close(); // Hide main menu while friends is open
		}
#endif
