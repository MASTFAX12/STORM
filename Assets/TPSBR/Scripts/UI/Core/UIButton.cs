...
namespace TPSBR.UI
{
	public class UIButton : Button
	{
		...
		public void PlayClickSound()
		{
			...
			// Dynamic/runtime buttons may exist outside UIWidget hierarchy.
			if (_parent == null)
				return;

			bool hasCustomClickSound = _customClickSound != null &&
			                           _customClickSound.Clips != null &&
			                           _customClickSound.Clips.Length > 0;

			if (hasCustomClickSound)
			{
