...
namespace TPSBR.UI
{
	public class UIGameplayView : UIView
	{
		...
		[SerializeField]
		private UIButton _scoreboardButton;
		...
		protected override void OnInitialize()
		{
			...
			if ((Application.isMobilePlatform == false || Application.isEditor == true) && Context.Settings.SimulateMobileInput == false)
			{
				...
				if (_scoreboardButton != null)
					_scoreboardButton.SetActive(false);
			}
			...
			if (_scoreboardButton != null)
			{
				_scoreboardButton.onClick.AddListener(OnScoreboardButton);
			}
		}
		...
		private void OnScoreboardButton()
		{
			var scoreboardView = SceneUI.Get<UIScoreboardView>();
			if (scoreboardView != null)
			{
				scoreboardView.Toggle();
			}
		}
